...
//	snprintf( str, 100, "Duty Cycle = %i%%; Duty Cycle Ratio (L:R): %i%%: %i:%i; Forward: %i     \r", ( int ) dutyCycle, ( int )steering, ( int ) dutyCycle * leftDC / 100, ( int ) dutyCycle * rightDC / 100, dataInt[ 2 ] >= 16000 ? MOTOR_FORWARD : MOTOR_BACKWARD );
//	uart0_transmitStr( str );

	setMotorDutyCycle( LEFT_MOTOR, ( int ) dutyCycle * leftDC / 100 );
	setMotorDutyCycle( RIGHT_MOTOR, ( int ) dutyCycle * rightDC / 100 );
